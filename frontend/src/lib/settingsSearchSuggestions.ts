...
const BASE_SUGGESTIONS: SettingsSearchSuggestion[] = [
  ...
  },
  {
    ...
    keywords: "accent couleur color bouton button chat bubble emerald amber cyan bleu blue vert orange profil profile",
  },
  {
    id: "availability-hours",
    tab: "general",
    label: "Disponibilité",
    hint: "Jours et heures de disponibilité",
    keywords: "availability disponibilité heures hours schedule calendrier working hours ouverture fermeture semaine weekdays",
  },
  {
    id: "audio-devices",
    tab: "audio",
  ...
  },
  {
    ...
    tab: "usage",
    label: "Forfait Pro",
    hint: "Plan personnel — crédits IA inclus",
    keywords: "forfait pro usage abonnement ia plan credit",
  },
  {
    id: "plan-pro-plus",
    tab: "usage",
    label: "Forfait Pro+",
    hint: "Même accès que Pro, plus de crédit utilisable",
    keywords: "forfait pro+ pro plus credit usage abonnement ia plan",
  },
  {
    id: "plan-team",
    tab: "usage",
    label: "Forfait Team",
    hint: "Sièges workspace, IA partagée",
    keywords: "forfait team entreprise seats sièges workspace plan usage",
  },
  {
    id: "billing",
    tab: "billing",
