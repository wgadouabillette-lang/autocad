    ...
    <button
      ...
      aria-label={
        workspaceEnterpriseActive
          ...
          : "Souscrire au forfait Entreprise pour le workspace sélectionné"
      }
    >
      <div className="settings-plan-card__header">
        ...
        <span className="settings-plan-card__price inline-flex items-center gap-1">
          ...
          {workspaceEnterpriseActive && enterpriseEnabled && !loading && (
      ...
      {!loading && !workspaceEnterpriseActive && enterpriseEnabled && (
        <p className="settings-plan-card__action">Pour le workspace sélectionné</p>
      )}
    </button>
  );
}
