...
export default function NotesFullscreenPromo() {
  ...
  return (
    <aside ref={asideRef} className="notes-fullscreen-promo" aria-label={t("chat.notesPromoAria")}>
      <div className="notes-fullscreen-promo__card">
        <div className="notes-fullscreen-promo__footer">
          <p className="notes-fullscreen-promo__title">{t("chat.notesPromoTitle")}</p>
          <p className="notes-fullscreen-promo__body">{t("chat.notesPromoBody")}</p>
          <button
            type="button"
            className="notes-fullscreen-promo__cta"
            onClick={() => openSettingsTab("usage")}
          >
            <span>{t("chat.notesPromoCta")}</span>
        ...
        <button
          ...
          aria-label={t("chat.notesPromoDismiss")}
          title={t("chat.notesPromoDismiss")}
