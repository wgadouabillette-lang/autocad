...
/** Chat panel list: live plugins (connected or not). Settings → Plugins still lists every card. */
export function isVisibleInChatConnectorsList(id: ChatConnectorId): boolean {
  return !isConnectorComingSoon(id);
}
