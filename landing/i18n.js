(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      "hero.shot.followup.alt": "Meetra preview — AI Notes after a completed meeting",
      "hero.shot.followup.title": "AI Notes",
      "hero.shot.followup.desc":
        "Live transcription during the call, then structured notes when you stop.",
      "hero.shot.followup.cta": "Try AI Notes",
      "featureTry.message": "Sure you want to download Meetra to try {feature}?",
      "featureTry.spotify": "Spotify",
      "featureTry.handoff": "handoff",
      "featureTry.followup": "AI Notes",
      ...
      "highlights.card6.tag": "Calendar",
      "highlights.card6.title": "Shared calendar",
      "highlights.card6.desc": "See the week, book time, and keep meetings next to the call.",
      ...
      "careers.intro.p1":
        "Meetra is a collaborative workspace — voice channels, AI chat, calendar, connectors, and AI Notes in one desktop app. We're building the tool we wished we had when juggling calls, chat, and a dozen tabs.",
      "careers.intro.p2":
    ...
    fr: {
      ...
      "hero.shot.followup.alt": "Aperçu Meetra — AI Notes après une réunion terminée",
      "hero.shot.followup.title": "AI Notes",
      "hero.shot.followup.desc":
        "Transcription en direct pendant l'appel, puis notes structurées à l'arrêt.",
      "hero.shot.followup.cta": "Essayer AI Notes",
      ...
      "highlights.card6.tag": "Calendrier",
      "highlights.card6.title": "Calendrier partagé",
      "highlights.card6.desc":
        "Voyez la semaine, réservez un créneau, et gardez les réunions à côté de l'appel.",
      "highlights.more": "View more product upgrades",
      "highlights.less": "View less product upgrades",
      "try.title": "Try Meetra Now.",
      "try.downloadMac": "Download for macOS",
      ...
      "careers.intro.p1":
        "Meetra est un espace de travail collaboratif — salons vocaux, chat IA, calendrier, connecteurs et AI Notes dans une seule app desktop. On construit l'outil qu'on aurait aimé avoir entre appels, chat et douzaines d'onglets.",
      "careers.intro.p2":
    ...
    es: {
      ...
      "hero.shot.followup.cta": "Probar AI Notes",
    ...
    de: {
      ...
      "hero.shot.followup.cta": "AI Notes ausprobieren",
    ...
    pt: {
      ...
      "hero.shot.followup.cta": "Experimentar AI Notes",
    ...
    it: {
      ...
      "hero.shot.followup.cta": "Prova AI Notes",
    ...
    ja: {
      ...
      "hero.shot.followup.cta": "AI Notes を試す",
    ...
    zh: {
      ...
      "hero.shot.followup.cta": "试用 AI Notes",
